angular.module('qh-test-front').factory('payService', ['appConfig', '$http', '$q', 'alertService', '$timeout', '$httpParamSerializer', "$state", '$mdDialog', '$rootScope', '$mdBottomSheet', '$interval', function (appConfig, $http, $q, alertService, $timeout, $httpParamSerializer, $state, $mdDialog, $rootScope, $mdBottomSheet, $interval) {
