...
(function () {
    angular.module('qh-test-front')
        .config(['$stateProvider', function ($stateProvider) {
            ...
            $stateProvider.state("main.selsectProduct", {
                url: "/selsectProduct",
                views: {
                    "@": {
                        templateUrl: 'biz/selsectProduct/selsectProduct.html',
            ...
            function selsectProductController($scope,$mdBottomSheet,$mdDialog) {
                ...
                //加入购物车成功
                $scope.showSelectCart = function (ev) {
                    $scope.alert = '';
                    $mdDialog.show({
                        templateUrl: 'biz/selsectProduct/success.html',
                        controller: selectCartController,
                        parent:'.ks-main '
